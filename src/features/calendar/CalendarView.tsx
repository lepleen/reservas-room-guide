...
/**
 * Presentational month calendar. Owns layout, navigation chevrons, and the
 * day-detail panel. Contains no routing, auth, or role knowledge — the
 * wrapper supplies data and the click handler.
 */
                ...
                .map((r) => (
                  <li key={r.id}>
                    <button
                      ...
                      className="w-full text-left flex items-center gap-3 rounded-md border border-border bg-card px-4 py-3 hover:border-primary/40 transition-colors"
                    >
